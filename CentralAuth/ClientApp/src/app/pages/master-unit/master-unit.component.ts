...
import { DeleteUnitComponent } from './dialogs/delete-unit/delete-unit.component';
...
export class MasterUnitComponent implements OnInit, OnDestroy {
  ...
  Edit(data: Unit) {
    const dialogRef = this._dialog.open(UpdateUnitComponent, {
      minWidth: DialogPopUpConfig.MIN_WIDTH,
      data: data,
      role: <any>DialogPopUpConfig.ROLE,
    });
  ...
  Delete(data: Unit) {
    const dialogRef = this._dialog.open(DeleteUnitComponent, {
      minWidth: DialogPopUpConfig.MIN_WIDTH,
      data: data,
      role: <any>DialogPopUpConfig.ROLE,
    });
